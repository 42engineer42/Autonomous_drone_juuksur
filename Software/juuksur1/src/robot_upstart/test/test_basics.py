...
class TestBasics(unittest.TestCase):
    ...
    def test_install(self):
        ...
        Software.juuksur1.src.robot_upstart.scripts.install(sudo=None, root=self.root_dir)
    ...
    def test_uninstall(self):
        ...
        j.add('robot_upstart', glob='test/launch/*.launch')
        Software.juuksur1.src.robot_upstart.scripts.install(sudo=None, root=self.root_dir)
        Software.juuksur1.src.robot_upstart.scripts.uninstall(sudo=None, root=self.root_dir)
